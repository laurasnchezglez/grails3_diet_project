...
<html>
    ...
    <body>
        ...
        <div id="show-dieta" class="content scaffold-show" role="main">
            ...
            <f:display bean="diet" />
            <g:form resource="${this.dieta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dieta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
